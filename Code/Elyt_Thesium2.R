...
dat <- data.Elytropappus.C  %>% mutate(Site = ifelse(Site == "Fynbos",1,0))
...
cat("
    ...
    beta[1] ~ dnorm(0, 0.8) #intercept
    beta[2] ~ dnorm(0, 0.8) #B Treatmment
...
setwd("C:/Users/Serayen/Research Work/Data")
#save(ssm2, file = "Elt_Th_R2_SSM.RData")
#load("Elt_Th_R2_SSM.RData")
setwd("C:/Users/Serayen/Research Work/Code")
