...
dat <- data.Elytropappus.C %>% ungroup(by = "Site") %>% mutate(Site = ifelse(Site == "Fynbos",1,0))
...
ssm2 <- jags(jags.data, inits, parameters, "Elytropappus.jag", n.chains = nc, n.thin = nt, n.iter = ni, n.burnin = nb) 
