...
dat <- data.Aspalathus.C  %>% mutate(Site = ifelse(Site == "Fynbos",1,0))
...
#Start Gibbs sampler: Run model in JAGS and save results in object called ssm
#***Useful Data is saved in objects so it is not necessary to run this to check the rest of the code
ssm3 <- jags(jags.data, inits, parameters, "AspalathusF.jag", n.chains = nc, n.thin = nt, n.iter = ni, n.burnin = nb) 

ssm3 <- autojags(ssm3, n.iter=1000)

setwd("C:/Users/Seray/Research Work/Data")
#save(ssm3, file = "AspalathusF_SSM.RData")
load("AspalathusF_SSM.RData")
setwd("C:/Users/Seray/Research Work/Code")

setwd("C:/Users/Seray/Research Work/Data")
#save(ssm3, file = "AspalathusF2_SSM.RData")
#load("AspalathusF2_SSM.RData")
setwd("C:/Users/Seray/Research Work/Code")
