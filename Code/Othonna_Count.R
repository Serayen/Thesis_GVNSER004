...
dat <- data.Othonna.C %>% mutate(Site = ifelse(Site == "Fynbos",1,0))
...
ssm2 <- jags(jags.data, inits, parameters, "OthonnaR.jag", n.chains = nc, n.thin = nt, n.iter = ni, n.burnin = nb) 
...
setwd("C:/Users/Seray/Research Work/Data")
#save(ssm2, file = "OthonnaR_SSM.RData")
#load("OthonnaR_SSM.RData")
setwd("C:/Users/Seray/Research Work/Code")

setwd("C:/Users/Seray/Research Work/Data")
#save(ssm2, file = "OthonnaR2_SSM.RData")
#load("OthonnaR2_SSM.RData")
setwd("C:/Users/Seray/Research Work/Code")
...
#Start Gibbs sampler: Run model in JAGS and save results in object called ssm
#***Useful Data is saved in objects so it is not necessary to run this to check the rest of the code
ssm3 <- jags(jags.data, inits, parameters, "OthonnaF.jag", n.chains = nc, n.thin = nt, n.iter = ni, n.burnin = nb) 

ssm3 <- autojags(ssm3, n.iter=1000)

setwd("C:/Users/Serayen/Research Work/Data")
#save(ssm3, file = "OthonnaF_SSM.RData")
#load("OthonnaF_SSM.RData")
...
denplot(ssm2, parms = "sig.plot")
traplot(ssm2, parms = "sig.plot" )

view(ssm2$BUGSoutput$summary)
