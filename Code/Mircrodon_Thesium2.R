...
cat("
    ...
    beta[2] ~ dnorm(0, 1) #B Treatmment
    beta[3] ~ dnorm(0, 1) #B Thesium Treatment
    beta[4] ~ dnorm(0, 1) #B Thesium Control
...
#Data for thesium in treatment plots, control plots set to zero
...
#Data for thesium in control plots, treatment plots set to zero
...
ssm2 <- autojags(ssm2, n.iter=10000)


setwd("C:/Users/Seray/Research Work/Data")
#save(ssm2, file = "Microdon_Th_R_SSM2.RData")
#load("Microdon_Th_R_SSM2.RData")
setwd("C:/Users/Seray/Research Work/Code")

setwd("C:/Users/Serayen/Research Work/Data")
#save(ssm2, file = "Microdon_Th_R2_SSM.RData")
#load("Microdon_Th_R2_SSM.RData")
